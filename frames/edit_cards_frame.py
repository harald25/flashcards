...
class EditCardsFrame(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        # Create header label
        self.edit_cards_header_label = ctk.CTkLabel(master=self, text="EDIT CARDS", font=ctk.CTkFont(size=18), anchor="center")
        self.edit_cards_header_label.grid(row=0, column=0, columnspan=2, padx=0, pady=(20, 30), sticky="ew")
        ...
        self.filter_cards_label = ctk.CTkLabel(master=self, text="Filter cards by topic")
        ...
        self.list_all_cards_frame = ListAllCardsFrame(parent=self, controller=self.controller, topic=self.topic)
        self.list_all_cards_frame.grid(row=4, column=0, columnspan=2, padx=20, pady=20, sticky="nsew")